...
class $LocalNotesTable extends LocalNotes
  ...
  @override
  List<GeneratedColumn> get $columns => [id, body, createdAt, syncStatus];
  @override
...
class LocalNote extends DataClass implements Insertable<LocalNote> {
  ...
  @override
  int get hashCode => Object.hash(id, body, createdAt, syncStatus);
  @override
...
class $$LocalNotesTableFilterComposer
    extends Composer<_$DatabaseService, $LocalNotesTable> {
...
class $$LocalNotesTableTableManager
    extends
        RootTableManager<
          ...
          (
            LocalNote,
            BaseReferences<_$DatabaseService, $LocalNotesTable, LocalNote>,
          ),
          LocalNote,
          PrefetchHooks Function()
        > {
  $$LocalNotesTableTableManager(_$DatabaseService db, $LocalNotesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
